...
| `time_input`                  | Time Input                  | To enter a time using the [system's time picker](https://developer.android.com/develop/ui/compose/components/time-pickers).                                                            | `{ "label": "Choose a time" }`                                                                                                                                                    |
