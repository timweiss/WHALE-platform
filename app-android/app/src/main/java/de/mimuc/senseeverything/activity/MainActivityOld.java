...
public class MainActivityOld extends AppCompatActivity {
	...
	private boolean checkPermission() {
		if (SDK_INT >= Build.VERSION_CODES.R) {
			...
			int result = ContextCompat.checkSelfPermission(MainActivityOld.this, Manifest.permission.READ_EXTERNAL_STORAGE);
			int result1 = ContextCompat.checkSelfPermission(MainActivityOld.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
	...
	private final OnClickListener onStartButtonClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			SEApplicationController.getInstance().getSamplingManager().startSampling(MainActivityOld.this);
		}
	};
	...
	private final OnClickListener onStopButtonClick = new OnClickListener() {
		...
		public void onClick(View v) {
			m_ButtonStart.setVisibility(View.VISIBLE);
			m_ButtonStop.setVisibility(View.GONE);
			SEApplicationController.getInstance().getSamplingManager().stopSampling(MainActivityOld.this);
		}
	};
	...
	private final OnClickListener onAccessibilityButtonClick = new OnClickListener() {
		@Override
		public void onClick(View v) {
			if (!isAccessibilityServiceEnabled(MainActivityOld.this))
			{
...
;	};
	...
	private final OnClickListener onEnrolmentButtonClick = view -> {
        ...
        Intent intent = new Intent(MainActivityOld.this, Onboarding.class);
